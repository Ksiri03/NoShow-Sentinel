...
export const predictionSchema = z.object({
  ...
  scheduled_iso: z.date({ required_error: "Scheduled date is required." }),
  appointment_iso: z.date({ required_error: "Appointment date is required." }),
...
}).refine(data => data.appointment_iso >= data.scheduled_iso, {
